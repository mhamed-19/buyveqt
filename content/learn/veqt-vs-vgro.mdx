...
Over rolling 20-year periods, 100% equity portfolios have historically outperformed 80/20 portfolios the vast majority of the time. In fact, over every 20+ year period in modern market history, 100% equity has come out ahead. The equity premium — the extra return you earn for accepting stock market volatility — is real and well-documented.

The 20% bond allocation in VGRO provides a psychological cushion, but at a real cost to long-term compounding. That bond drag reduces expected returns by roughly 0.5-1% per year on average. Over 25 years, that difference compounds into tens of thousands of dollars on a typical portfolio. For an investor with a 10+ year horizon who can stay the course, VEQT is the mathematically stronger choice.
