...
- **Distributions** — VEQT pays quarterly distributions. These show up on your T3 tax slip and are taxed in the year they're received. The tax treatment depends on the type of income (Canadian dividends, foreign income, return of capital — VEQT's distributions include a mix).
