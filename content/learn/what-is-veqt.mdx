...
**It works in any registered account.** You can hold VEQT in a TFSA, RRSP, RESP, or non-registered account. It works the same way everywhere, though the [tax implications differ](/learn/veqt-in-tfsa-vs-rrsp-vs-non-registered).
