...
description: "The most common question in Canadian ETF investing. Two nearly-identical all-equity ETFs that differ in ownership, portfolio construction, and who they're built to serve — and a five-year performance edge VEQT investors don't usually claim."
slug: "veqt-vs-xeqt"
readingTime: "12 min read"
lastUpdated: "2026-04-26"
excerpt: "VEQT owns 50% more companies than XEQT, has slightly outperformed it over five years, and is built by a company owned by its investors. Here's the case, made carefully."
category: "comparison"
difficulty: "beginner"
...
<Summary>
VEQT owns nearly 13,700 companies. XEQT owns ~9,300. That's roughly 50% more of the global market in one ticker — and the deeper differences (investor-owned vs publicly-traded, market-cap vs fixed targets, broader emerging-markets reach) all point the same direction. Both are excellent products and you'll do well with either. But if you're choosing for the first time, the structural case for VEQT is real.
</Summary>

<TableOfContents items="The Basics | Geographic Allocation | What About Performance? | The Companies Behind the Ticker | The Pioneer and the Fast-Follower | The Vanguard Effect | Market-Cap Weighting vs Fixed Targets | The Canadian Home Bias | Broader Diversification | Common Deciding Factors | Common Objections, Answered | The Bottom Line" />
...
| Window | VEQT | XEQT | Winner |
|--------|------|------|--------|
| YTD 2026 | 7.02% | 6.86% | VEQT |
| 2025 full year | 20.45% | 20.45% | Tied |
| 5-year annualized | 12.69% | 12.45% | VEQT |
...
US has been winning recently. That doesn't mean it always will. Choosing an ETF based on the last decade's regional leaders is exactly the active bet passive investing is meant to avoid. And on the data: VEQT has actually slightly outperformed XEQT over the past five years anyway.

**"BlackRock has more scale and resources than Vanguard."**
True for the parent company. Irrelevant for a passively-managed index ETF. Both products track baskets of stocks; "scale" doesn't make a tracking fund track better. Both have AUM measured in billions. The product mechanic is essentially the same.

**"VEQT's heavier Canadian weight is concentration risk."**
Canada is roughly 3% of global market cap, and both funds overweight it (VEQT 30%, XEQT 25%). The home-country bias is deliberate and research-backed: it lowers volatility for Canadian investors whose expenses are in CAD, and Canadian-eligible dividends get preferential tax treatment in non-registered accounts. A 30% allocation to the country whose currency you spend in is not concentration — it's alignment.
