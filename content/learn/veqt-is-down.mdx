...
difficulty: "beginner"
tags: ["market-drop", "volatility", "psychology", "long-term", "dont-sell"]
relatedSlugs: ["getting-started-with-veqt", "passive-investing-behavioral-edge", "why-stocks-go-up", "why-timing-the-market-fails"]
isEditorial: true
---
...
**Need perspective?** Check the [BuyVEQT homepage](/) for current performance and the daily pulse, use the [If You Invested calculator](/invest) to see how past drops recovered, or visit [r/JustBuyVEQT](https://www.reddit.com/r/JustBuyVEQT/) where others are going through the same thing.
