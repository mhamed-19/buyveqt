...
**Need perspective?** Check the [VEQT Today](/today) page for current performance, use the [If You Invested calculator](/invest) to see how past drops recovered, or visit [r/JustBuyVEQT](https://www.reddit.com/r/JustBuyVEQT/) where others are going through the same thing.
