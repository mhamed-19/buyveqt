...
tags: ["currency", "hedging", "risk"]
relatedSlugs: ["veqt-is-down", "veqt-vs-diy-portfolio", "veqt-canadian-home-bias"]
isEditorial: false
order: 13
---
...
A concrete example: in Q3 2024, the S&P 500 returned roughly 5.5% in USD terms. But the Canadian dollar strengthened from about $0.73 to $0.74 USD during the same period — a ~1.4% CAD appreciation. Canadian investors holding unhedged US equities saw roughly 4% returns in CAD terms instead of 5.5%. The stocks performed identically; the lens you viewed them through changed the number.

The reverse happened throughout 2015, when the CAD weakened from $0.86 to $0.72 USD — a nearly 16% decline. Canadian holders of US equities got a massive currency tailwind that year, with their US returns boosted by double digits in CAD terms, even as the S&P 500 itself was roughly flat.
