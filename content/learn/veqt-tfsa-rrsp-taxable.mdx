...
relatedSlugs: ["getting-started-with-veqt", "veqt-mer-true-cost", "veqt-in-your-fhsa"]
isEditorial: true
---
...
<Summary>
For most Canadians: TFSA first, RRSP second, taxable third. If you're a first-time home buyer, the FHSA jumps to the front of the line. The details matter for optimization, but the most important thing is that you start investing — not that you pick the perfect account.
</Summary>

<TableOfContents items="The Account Question | Quick Primer on Account Types | VEQT in a TFSA | VEQT in an RRSP | VEQT in a Taxable Account | The Priority Order for Most People | What About the FHSA? | The Honest Answer" />
...
<ComparisonTable
  highlight="TFSA"
  headers=" | TFSA | RRSP | FHSA | Taxable"
  rows="Contribution limit | $7,000/yr | 18% of income | $8,000/yr | Unlimited ;; Tax on contributions | After-tax | Deductible | Deductible | After-tax ;; Tax on growth | Tax-free | Tax-deferred | Tax-free | Taxable annually ;; Tax on withdrawal | Tax-free | Taxed as income | Tax-free for home | Capital gains taxed ;; Foreign withholding tax | Not recoverable | Partially recoverable | Not recoverable | Recoverable via credit ;; Best for | Most Canadians | High earners | First-time buyers | After registered maxed"
/>
...
<Callout type="tip">
If your employer offers RRSP matching, always take the full match before contributing elsewhere. It's free money — a 100% guaranteed return.
</Callout>
...
Only use a taxable account for VEQT after you've maxed your TFSA, RRSP, and FHSA (if eligible). Every dollar in a registered account grows tax-free or tax-deferred — that benefit is too valuable to leave on the table.
</Callout>
...
1. **FHSA first.** The double tax benefit (deduction + tax-free withdrawal) beats every other account for home-buying money. [Read our FHSA guide](/learn/veqt-in-your-fhsa) for details.
...
<Callout type="info">
Even if you're not ready to contribute much, open the FHSA now. Carry-forward room only starts accumulating once the account exists — waiting means losing contribution room you can never get back.
</Callout>

Whether VEQT belongs in your FHSA depends entirely on your timeline to purchase — we've written a [full guide to using VEQT in your FHSA](/learn/veqt-in-your-fhsa) that covers the time-horizon framework in detail.

<Callout type="tip">
If your employer offers RRSP matching, always contribute enough to get the full match — even before maxing your TFSA. Employer matching is an instant 50-100% return on your money. No investment strategy beats free money.
</Callout>
